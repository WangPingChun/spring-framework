...
/**
 * 是 ResourcePatternResolver 最常用的子类,它除了支持 ResourceLoader 和 ResourcePatternResolver
 * 新增的 "classpath*:" 前缀外,还支持 Ant 风格的路径匹配模式(类似于 <code>**\\/*.xml</code>"")
 * <p>
 * <p>
...
public class PathMatchingResourcePatternResolver implements ResourcePatternResolver {
	...
	public Resource[] getResources(String locationPattern) throws IOException {
		...
		// 不以 "classpath*:" 开头
			...
			// 而在 Tomcat 上只有在 "*/" 分割符之后才为其 "war:" 协议
	...
	protected String determineRootDir(String location) {
		...
		// 如果查找完成后 rootDirEnd = 0 了, 则将之前赋值的 prefixEnd 的值赋值给 rootDirEnd
		if (rootDirEnd == 0) {
