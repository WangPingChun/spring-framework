...
public abstract class AbstractRefreshableWebApplicationContext extends AbstractRefreshableConfigApplicationContext
	...
	protected void postProcessBeanFactory(ConfigurableListableBeanFactory beanFactory) {
		// 添加 ServletContextAwareProcessor 到 BeanFactory 中，该 processor 实现 BeanPostProcessor 接口，主要用于将 ServletContext
		// 传递给实现了 ServletContextAware 接口的 bean
		beanFactory.addBeanPostProcessor(new ServletContextAwareProcessor(this.servletContext, this.servletConfig));
		// 忽略 ServletContextAware、ServletConfigAware 的自动装配
		beanFactory.ignoreDependencyInterface(ServletContextAware.class);
		beanFactory.ignoreDependencyInterface(ServletConfigAware.class);
		// 注册 WEB 应用特定的 scope 到 beanFactory 中，以便 WebApplicationContext 可以使用他们
		WebApplicationContextUtils.registerWebApplicationScopes(beanFactory, this.servletContext);
		// 注册 WEB 应用特定的 Environment bean 到 beanFactory 中，以便 WebApplicationContext 可以使用他们
