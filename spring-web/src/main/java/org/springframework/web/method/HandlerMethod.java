...
public class HandlerMethod {
	 ...
	 *
	 * 仅构造方法中传入 HandlerMethod 类型的参数使用，
	 * 例如 {@link #HandlerMethod(HandlerMethod)}
	 */
	@Nullable
	...
	public HandlerMethod(Object bean, Method method) {
		...
		// 初始化 method 和 bridgeMethod 属性
		this.method = method;
		this.bridgedMethod = BridgeMethodResolver.findBridgedMethod(method);
		// 初始化 parameters 属性
		this.parameters = initMethodParameters();
		// 初始化 responseStatus 和 responseStatusReason 属性
	...
	public HandlerMethod createWithResolvedBean() {
		...
		// 如果 bean 是 String 类型，则获取对应的 handler 对象
		// 例如，bean = userController 字符串
