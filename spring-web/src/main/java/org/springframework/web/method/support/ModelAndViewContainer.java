...
public class ModelAndViewContainer {
	/**
	 * 是否在 redirect 重定向时忽略 {@link #redirectModel}
	 */
	...
	private boolean useDefaultModel() {
		// 1、处理器返回 redirect 视图标识为 false
		// 2、redirectModel 重定向 Model 为空，并且 ignoreDefaultModelOnRedirect 为 false
