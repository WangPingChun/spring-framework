...
public abstract class AbstractTemplateViewResolver extends UrlBasedViewResolver {
	...
	/**
	 * 当 RequestAttributes 中存在 Model 中同名的参数，是否允许使用 RequestAttributes 中的值
	 * 将 Model 中的值进行覆盖
	 */
	...
	/**
	 * 当 SessionAttributes 中存在 Model 中同名的参数，是否允许使用 SessionAttributes 中的值
	 * 将 Model 中的值进行覆盖
	 */
	private boolean allowSessionOverride = false;

	/**
	 * 是否将 RequestContext 暴露给 View 为 Spring 的宏（Macro）使用
	 */
